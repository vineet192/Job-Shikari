	...
	<div class="image">
		<div class="card">
			<div class="card-body">
				...
				<form action="EmployeeOtpEnterServlet" method="GET">
					<center>
			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="list-unstyled list-inline social text-center">
						...
						<li class="list-inline-item"><a href="..."><li
								class="list-inline-item"><a href="about_us.html"><i
										class="fa fa-info-circle" style="font-size: 24px"></i></a></li></a></li>
					</ul>
				</div>
			</div>
			<div class=about>
